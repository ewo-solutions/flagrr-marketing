      ...
      <div style={{ maxWidth: 820, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          <div style={{ display: "inline-flex", alignItems: "center", gap: 9, padding: "7px 13px", borderRadius: 999, background: "rgba(205,222,92,.14)", border: "1px solid rgba(205,222,92,.5)" }}>
            ...
            <span style={{ fontFamily: "var(--font-mono)", fontSize: 9.5, letterSpacing: ".18em", textTransform: "uppercase", color: "#CDDE5C" }}>early club special · first 3 months</span>
          </div>
          ...
          <p style={{ margin: "18px 0 0", maxWidth: "40ch", fontSize: 13.5, fontWeight: 300, lineHeight: 1.6, color: "rgba(246,245,240,.7)" }}>
            R2 500 a month for your first three months as an early joining club, then R5 250 / month ex VAT. Unlimited members, every feature.
          </p>
        </Reveal>
