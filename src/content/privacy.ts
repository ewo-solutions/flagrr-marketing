...
export const privacySections: LegalSection[] = [
  {
    ...
    body: [
      "This policy covers golfers using the Flagrr app, club staff using the club console, and visitors to this website. Flagrr is operated by [ LEGAL ENTITY NAME ], registration number [ NUMBER ], of [ REGISTERED ADDRESS ].",
    ],
  },
  {
